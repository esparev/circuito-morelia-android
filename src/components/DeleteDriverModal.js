...
const DeleteDriverModal = props => {
  ...
  const handleSubmit = () => {
    deleteDriver(`${envConfig.apiUrl}/users/${slug}`, {
      headers: {
        ...
        <View style={modalStyles.editModal}>
          <View style={modalStyles.modalContainer}>
            <View style={modalStyles.modalHeader}>
              <Text style={modalStyles.modalTitle}>Eliminar Conductor</Text>
            ...
            {confirmed ? (
              ...
              <View style={modalStyles.modalForm}>
                <Pressable
                  ...
                  <Text style={buttonStyles.btnTxt}>Eliminar Conductor</Text>
                </Pressable>
              </View>
            )}
          </View>
