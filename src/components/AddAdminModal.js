...
const AddAdminModal = props => {
  ...
  const formik = useFormik({
    ...
    onSubmit: data => {
      ...
      addAdmin(`${envConfig.apiUrl}/users/admin`, data, {
        headers: {
        ...
        <View style={modalStyles.editModal}>
          <View style={modalStyles.modalContainer}>
            <View style={modalStyles.modalHeader}>
              <Text style={modalStyles.modalTitle}>Agregar Administrador</Text>
            ...
            <View style={modalStyles.modalForm}>
              ...
              <Pressable
                ...
                <Text style={buttonStyles.btnTxt}>Agregar Administrador</Text>
              </Pressable>
            </View>
          </View>
        </View>
